...
def run(
    ...
    module = base_runner._load_graphdrp_module(root_dir)
    ...
    for fold in resolve_fold_ids(split_dir, fold_ids):
        ...
        if protocol == "random":
            ...
            train_scope = base_runner._build_scope(dataset, base_runner._concat_pairs(train_pairs), train_pairs, runtime_device, top_k)
            val_scope = base_runner._build_scope(dataset, base_runner._concat_pairs(train_pairs, val_pairs), train_pairs, runtime_device, top_k)
            test_scope = base_runner._build_scope(dataset, base_runner._concat_pairs(train_pairs, test_pairs), train_pairs, runtime_device, top_k)
