"""
model_scalable.py
Locked scalable SOUL-CDR architecture:
- Drug encoder: GIN
...
NOTE:
ScalableCellLineRepresentationModule is intentionally kept unchanged.
"""
...
class ScalableCellLineRepresentationModule(nn.Module):
    """
...
class SOULCDR(nn.Module):
    """
    Locked scalable SOUL-CDR (single architecture only):
    - Drug branch: GIN
    - Cell branch: ScalableCellLineRepresentationModule (unchanged)
    ...
    def __init__(
        ...
        self.cell_line_module = ScalableCellLineRepresentationModule(
